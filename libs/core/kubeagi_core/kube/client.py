...
class KubeEnv:
    ...
    def get_datasource_object(self, namespace: str, name: str):
        ...
        return CustomObjectsApi().get_namespaced_custom_object(
            group=arcadia_resource_datasources.get_group(),
            version=arcadia_resource_datasources.get_version(),
            namespace=namespace,
...
class VersionedDatasets(KubeEnv):
...
class Models(KubeEnv):
    def get_models_status(self, namespace: str, name: str):
        return CustomObjectsApi().get_namespaced_custom_object_status(
...
class Embedders(KubeEnv):
    def get_embedding_status(self, namespace: str, name: str):
        return CustomObjectsApi().get_namespaced_custom_object_status(
